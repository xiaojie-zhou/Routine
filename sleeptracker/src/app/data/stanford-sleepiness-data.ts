...
export class StanfordSleepinessData extends SleepData {
	public static ScaleValues = ["I don't know",//Sleepiness scale starts at 1
    ...
    return "Time: "
      + this.loggedAt.toLocaleDateString('en-US', {weekday: 'long', month: 'long', day: 'numeric' })
      + ", "
      + ("0" + this.loggedAt.getHours()).slice(-2)
      + ":"
      + ("0" + this.loggedAt.getMinutes()).slice(-2);
	}
